	...
	<div class="box" style="padding:0px 10px;margin-bottom:10px;">
		<form id="uxFrondendBookingForm" class="form-horizontal" method="post" action="">
			<div class="content">
				...
				<div class="progressbar-normal blue  ui-progressbar ui-widget ui-widget-content ui-corner-all" value="75%" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="75" style="width:100%;float:left;">
						...
						<?php
							...
							(
								...
								(
									...
									'.servicesTable().'.ServiceTotalTime,'.servicesTable().'.ServiceColorCode, '.servicesTable().'.ServiceFullDay FROM '.servicesTable().'  ORDER BY ' . servicesTable() . '.ServiceDisplayOrder ASC',''
								)
						);
			...
			<div id="calendarGrid" style="width:100%; display:none;float:left;">
				<div id="calBindingMultiple" style="float:left;width:25%"></div>	
				<div id="timingSlot" style="float:left;width:72%;padding:5px;border:solid 1px #ECECEC;">
							...
							<div class="content">
								...
								?>
											<div class="row" name="uxControl<?php echo $bookingFeild[$flagField]->BookingFormId;?>" id="uxControl<?php echo $bookingFeild[$flagField]->BookingFormId;?>">
												<label>
													<?php _e($bookingFeild[$flagField]->BookingFormField, bookings_engine ); ?>
													<?php
